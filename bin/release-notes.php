 ...
 *
 * A version with no entry exits 1, and the workflow answers that by letting
 * GitHub generate the notes from the commits instead. The exit code is for the
 * workflow to branch on, not a reason to stop a release.
 *
 * Usage:
